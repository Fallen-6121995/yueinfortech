...
import { ArrowUpRight, Facebook, Instagram, Linkedin, Sparkles } from "lucide-react";
...
import rocketImg from "@/assets/theme-images/man-with-seo-eocke-slider.png";
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0d0806] via-[#120b08] to-[#1c120b] text-foreground">
      ...
      <Image
        src={growArrow}
        alt=""
        className="pointer-events-none absolute right-[11%] top-[28%] hidden w-28 sm:block sm:w-32 md:w-40 lg:w-48 xl:w-56 opacity-90"
      />
      ...
      {/* ⭐ FIX #1 → Remove top padding and center hero vertically */}
      <div className="container relative z-10 flex min-h-screen items-center">
        
        {/* ⭐ FIX #2 → items-start to prevent image column from centering */}
        <div className="grid h-full w-full flex-1 gap-8 sm:gap-10 lg:gap-16 
          ...
          <div className="space-y-6 text-left lg:space-y-8">
            ...
            {/* Heading */}
            <h1 className="text-[1.95rem] font-bold leading-[1.14] tracking-[0.5px]
      ...
      {/* =====================================================
          WOMAN FIGURE — bottom-aligned + responsive hide
      ===================================================== */}
